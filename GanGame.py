...
class GANGame:
    ...
    def entrenar_lote(self, imagenes_rayadas, imagenes_buenas):
        ...
        perdida_g = self.criterio_perceptual(imagenes_generadas, imagenes_buenas)  # Aquí usamos la CombinedLoss
    ...
    def entrenar(self, cargador_datos, num_epochs, intervalo_visualizacion=5, intervalo_guardado=10, ruta_guardado="/home/rodrigo/Documentos/5to semestre/machin/modelosGAN/"):
        for epoch in range(num_epochs):
            ...
            # Visualizar y guardar modelos en intervalos específicos
